...
function DadIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
      <path
        d="M9 24C9 16 13 9 21 9C29 9 33 16 33 24"
        stroke={c}
        strokeWidth="1.5"
        fill="none"
      />
      ...
      <path
        d="M15 29C16 33 18 36 21 37C24 36 26 33 27 29"
        stroke={c}
        strokeWidth="1.2"
        fill="none"
      />
...
function NoonieIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
      <path
        d="M11 18C11 12 15 8 21 8C27 8 31 12 31 18L31 30"
        stroke={c}
        strokeWidth="1.2"
        fill="none"
      />
      ...
      <path
        d="M12 16L15 11L18 14L21 10L24 14L27 11L30 16"
        stroke={c}
        strokeWidth="1.3"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      <path
        d="M19 25.5Q21 27 23 25.5"
        stroke={c}
        strokeWidth="0.8"
        fill="none"
      />
      <path
        d="M11 24C9 26 9 30 10 34"
        stroke={c}
        strokeWidth="1.2"
        strokeLinecap="round"
        fill="none"
...
function AbbatIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
      <path
        d="M10 22C10 14 14 8 21 8C28 8 32 14 32 22"
        stroke={c}
        strokeWidth="1.5"
        fill="none"
      />
      ...
      />
      <path
        d="M16 31C17 34 21 36 21 36C21 36 25 34 26 31"
        stroke={c}
        strokeWidth="1.2"
        fill="none"
      />
...
function OdinIcon({ active }: { active: boolean }) {
  ...
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
      <path
        d="M10 24C10 17 13 11 20 10C27 11 31 15 31 22"
        stroke={c}
        strokeWidth="1.4"
        fill="none"
      />
  ...
  return (
    ...
    >
      <svg width="1200" height="1400" viewBox="0 0 500 560" fill="none">
        ...
        <path
          d="M228 220Q225 270 223 320Q221 360 219 400L281 400Q279 360 277 320Q275 270 272 220Z"
          fill="#c9a84c"
        />
        <path
          d="M219 395Q185 415 140 445Q105 465 75 478L80 486Q125 460 165 435Q200 418 224 405Z"
          fill="#c9a84c"
        />
        <path
          d="M281 395Q315 415 360 445Q395 465 425 478L420 486Q375 460 335 435Q300 418 276 405Z"
          fill="#c9a84c"
        />
        <path
          d="M236 400Q238 428 241 465L259 465Q262 428 264 400Z"
          fill="#c9a84c"
        />
      </svg>
    </div>
  ...
  return (
    <div className="grain-overlay min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 30%, rgba(30,25,15,1) 0%, rgba(10,12,16,1) 60%, #000 100%)",
        }}
      />
      <YggdrasilBg />
      <RuneParticles />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3 mt-3">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(270deg, transparent, rgba(201,168,76,0.4))",
              }}
            />
          </div>
        </div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 30px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(201,168,76,0.05)",
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex gap-2">
              <span style={{ color: "rgba(201,168,76,0.25)", fontSize: 12 }}>
                ◆
              </span>
              <span
                style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Turnstile — hides after verification */}
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, #8a6d2b 0%, #c9a84c 50%, #8a6d2b 100%)",
                color: "#0a0c10",
                boxShadow:
                  "0 4px 24px rgba(201, 168, 76, 0.15), inset 0 1px 0 rgba(232,212,139,0.3)",
                fontFamily: "'Cinzel', serif",
                letterSpacing: 4,
              }}
            >
